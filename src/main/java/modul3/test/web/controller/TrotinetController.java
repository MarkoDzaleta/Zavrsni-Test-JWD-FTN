...
public class TrotinetController {
	...
	@GetMapping
	public ResponseEntity<List<TrotinetDTO>> getAll(@RequestParam(required = false) Long adresaId,
			@RequestParam(required = false) Integer baterijaOd, @RequestParam(required = false) Integer baterijaDo,
